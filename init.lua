...
vim.keymap.set("n", "<left>", ":vertical resize -1<Return>", { desc = "Resize vertically -1" })
vim.keymap.set("n", "<right>", ":vertical resize +1<Return>", { desc = "Resize vertically +1" })
vim.keymap.set("n", "<up>", ":resize +1<Return>", { desc = "Resize +1" })
...
require("lazy").setup({
	...
	{ -- Adds git related signs to the gutter, as well as utilities for managing changes
		...
		config = function()
			...
			gitsigns.setup()
			vim.keymap.set("n", "<leader>gp", gitsigns.prev_hunk, { desc = "Gitsigns go to previous hunk" })
